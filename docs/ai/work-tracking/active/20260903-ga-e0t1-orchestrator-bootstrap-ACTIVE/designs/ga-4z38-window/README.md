...
**Job.** Job `ga-4z38-observe` runs `operator/OBSERVE.sh` at this commit. Its output root is
`/var/tmp/ga-4z38-integrity-20260923-r1`, and round 2b pins that output as the window's integrity
baseline.

## Round 2b (next commit): the window
