...
WATCH_SHA=e0a2cce750f4c37ff946700c74fa88872dafee2058e962f5aa534790dabcbea8
...
step() {
  ...
  rc=$?
  if [ "$rc" != 0 ]; then
    echo "== WATCH REFUSED at $label rc=$rc: read this log and the named roots; run nothing else"
