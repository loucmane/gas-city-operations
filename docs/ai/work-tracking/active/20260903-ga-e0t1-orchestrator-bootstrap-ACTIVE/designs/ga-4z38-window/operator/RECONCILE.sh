...
RECONCILE_SHA=28a3b2256bc317e90fcf8b4b5bb775ddff07f06ced68a21cd0d5ab0ea7f98fbc
...
step() {
  ...
  rc=$?
  if [ "$rc" != 0 ]; then
    echo "== RECONCILE REFUSED at $label rc=$rc: read this log and the named roots; run nothing else"
