#!/bin/sh
# ga-4z38 window preflight: read-only admission of the window against the fresh integrity
# observation (OBSERVE.sh). It creates the window root and stages nothing.
#
# Runs as a job of the host job runner (designs/gct-jobrunner), a oneshot unit started by the runner.
# Log: ~/.local/share/gas-city-staging/ga-4z38-window/preflight-<timestamp>.txt. Exits with the first failing
# step's result, or 0.
...
FRESHEN_SHA=7422a39777a613c3f03f61e47ef85f22718d9b8189d5efbfb800cd97b9532781
