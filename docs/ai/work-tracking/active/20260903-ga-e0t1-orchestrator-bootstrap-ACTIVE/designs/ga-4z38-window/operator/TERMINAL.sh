#!/bin/sh
# ga-4z38 window terminal: the full native integrity observation of the restored baseline,
# bound to the terminal suspension endpoint and the accepted restoration.
#
# Runs as a job of the host job runner (designs/gct-jobrunner), a oneshot unit started by the runner.
# Log: ~/.local/share/gas-city-staging/ga-4z38-window/terminal-<timestamp>.txt. Exits with the first failing
# step's result, or 0.
...
TERMINAL_SHA=d378486e3e5eb88c143d75ed86d2a6ac43696265a48faa1ef4c8e8eb6c5d959b
...
{ [ ! -e /var/tmp/ga-4z38-terminal-20260923-r1 ] && [ ! -L /var/tmp/ga-4z38-terminal-20260923-r1 ]; } || { echo "== STOP: output root already used: /var/tmp/ga-4z38-terminal-20260923-r1"; echo "== end"; exit 1; }
step() {
  label=$1; shift
