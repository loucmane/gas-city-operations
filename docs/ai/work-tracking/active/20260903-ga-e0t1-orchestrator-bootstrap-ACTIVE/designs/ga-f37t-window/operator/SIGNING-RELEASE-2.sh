...
# Log: ~/.local/share/gas-city-staging/ga-f37t-window/signing-release-2-<timestamp>.txt. Exits with the first failing
# step's result, or 0.
...
RELEASE_SHA=af8f4a93b3dea2b09ffe39a71fc67407a62abdf88b24e92325f7197ffdf32a01
