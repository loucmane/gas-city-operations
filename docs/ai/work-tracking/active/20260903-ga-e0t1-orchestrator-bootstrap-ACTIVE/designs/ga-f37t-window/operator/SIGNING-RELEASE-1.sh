...
# Log: ~/.local/share/gas-city-staging/ga-f37t-window/signing-release-1-<timestamp>.txt. Exits with the first failing
# step's result, or 0.
...
RELEASE_SHA=227fa3c93d462182b6bf824b8b134e0f4a4e79b50be94979c391c52979051e01
