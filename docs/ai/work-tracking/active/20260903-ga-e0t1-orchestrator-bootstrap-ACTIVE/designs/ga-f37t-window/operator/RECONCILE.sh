...
# Log: ~/.local/share/gas-city-staging/ga-f37t-window/reconcile-<timestamp>.txt. Exits with the first failing
# step's result, or 0.
...
RECONCILE_SHA=64049293bcff0f668cfbfccab9c4334a3f03a5a0f53c8a9cf5d1daeacb2a8f47
...
{ [ ! -e /var/tmp/ga-f37t-reconcile-20260923-r1 ] && [ ! -L /var/tmp/ga-f37t-reconcile-20260923-r1 ]; } || { echo "== STOP: output root already used: /var/tmp/ga-f37t-reconcile-20260923-r1"; echo "== end"; exit 1; }
step() {
  label=$1; shift
