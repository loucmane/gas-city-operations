#!/bin/sh
# ga-f37t window hold: emergency scheduling hold for a STRANDED window only (a lifecycle failure record
...
# Log: ~/.local/share/gas-city-staging/ga-f37t-window/hold-1-<timestamp>.txt. Exits with the first failing
# step's result, or 0.
...
HOLD_SHA=6df50405d8bdaf5f40ad3b1d0a56c8c1a2b1d2f30a27caa5178619691f38638c
