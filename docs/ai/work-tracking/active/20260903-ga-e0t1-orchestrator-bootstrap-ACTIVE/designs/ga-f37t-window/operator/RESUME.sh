...
WINDOW_SHA=0ed6adb28f80a572c7207be8eb05461e7da737e199368e988bbeedb99c653b5d
...
{ [ ! -e /var/tmp/ga-f37t-window-20260925-r2/rig-resume-started.json ] && [ ! -L /var/tmp/ga-f37t-window-20260925-r2/rig-resume-started.json ]; } || { echo "== STOP: output root already used: /var/tmp/ga-f37t-window-20260925-r2/rig-resume-started.json"; echo "== end"; exit 1; }
step() {
  label=$1; shift
