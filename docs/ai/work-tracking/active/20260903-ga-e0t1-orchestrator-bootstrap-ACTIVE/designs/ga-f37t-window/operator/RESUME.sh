#!/bin/sh
# ga-f37t window resume: rig-resume, the read-only queue audit, then city-resume, once each.
#
# Runs as a job of the host job runner (designs/gct-jobrunner), a oneshot unit started by the runner.
# Log: ~/.local/share/gas-city-staging/ga-f37t-window/resume-<timestamp>.txt. Exits with the first failing
# step's result, or 0.
...
WINDOW_SHA=089410a9f9371c8bdd2bd4941a6b5a64ff959ad4661242bffa7575f3f571413d
...
[ -e /var/tmp/ga-f37t-route-20260923-r1/result.json ] && [ -e /var/tmp/ga-f37t-audit-route-20260923-r1/result.json ] || { echo "== STOP: ROUTE has not passed"; echo "== end"; exit 1; }
...
{ [ ! -e /var/tmp/ga-f37t-audit-resume-20260923-r1 ] && [ ! -L /var/tmp/ga-f37t-audit-resume-20260923-r1 ]; } || { echo "== STOP: output root already used: /var/tmp/ga-f37t-audit-resume-20260923-r1"; echo "== end"; exit 1; }
{ [ ! -e /var/tmp/ga-f37t-window-20260923-r1/rig-resume-started.json ] && [ ! -L /var/tmp/ga-f37t-window-20260923-r1/rig-resume-started.json ]; } || { echo "== STOP: output root already used: /var/tmp/ga-f37t-window-20260923-r1/rig-resume-started.json"; echo "== end"; exit 1; }
step() {
  label=$1; shift
