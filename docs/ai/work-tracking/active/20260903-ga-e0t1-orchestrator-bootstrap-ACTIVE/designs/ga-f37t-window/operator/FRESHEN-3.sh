...
{ [ ! -e /var/tmp/ga-f37t-integrity-20260924-r2 ] && [ ! -L /var/tmp/ga-f37t-integrity-20260924-r2 ]; } || { echo "== STOP: output root already used: /var/tmp/ga-f37t-integrity-20260924-r2"; echo "== end"; exit 1; }
