#!/bin/sh
# ga-gegx window observe: the fresh accepted-state admission plus a full native integrity read,
...
# Log: ~/.local/share/gas-city-staging/ga-gegx-window/observe-<timestamp>.txt. Exits with the first failing
# step's result, or 0.
...
OBSERVE_SHA=4e958882c190dd1092d27ad0179724e1e39d6aa013ae05c73e4e29fe89b1e3ff
...
{ [ ! -e /var/tmp/ga-gegx-integrity-20260925-r5 ] && [ ! -L /var/tmp/ga-gegx-integrity-20260925-r5 ]; } || { echo "== STOP: output root already used: /var/tmp/ga-gegx-integrity-20260925-r5"; echo "== end"; exit 1; }
step() {
  label=$1; shift
