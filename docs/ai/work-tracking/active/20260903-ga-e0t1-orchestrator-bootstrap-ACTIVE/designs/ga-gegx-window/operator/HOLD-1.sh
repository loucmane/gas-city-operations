#!/bin/sh
# ga-gegx window hold: emergency scheduling hold for a STRANDED window only (a lifecycle failure record
...
# Log: ~/.local/share/gas-city-staging/ga-gegx-window/hold-1-<timestamp>.txt. Exits with the first failing
# step's result, or 0.
...
HOLD_SHA=303296cd78d5903730f479fa521ef06cd28a7c4d2152e8f68f13dadfbb16b934
...
[ -e /var/tmp/ga-gegx-window-20260925-r2/stage-consumed.json ] || { echo "== STOP: no staged window"; echo "== end"; exit 1; }
step() {
  label=$1; shift
