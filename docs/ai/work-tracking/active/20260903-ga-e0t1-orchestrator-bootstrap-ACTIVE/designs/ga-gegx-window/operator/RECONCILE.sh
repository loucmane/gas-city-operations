#!/bin/sh
# ga-gegx window reconcile: the reviewed status-only hold of the consumed fourth-successor task
# (blocked, route and evidence preserved), before BIND.
#
# Runs as a job of the host job runner (designs/gct-jobrunner), a oneshot unit started by the runner.
# Log: ~/.local/share/gas-city-staging/ga-gegx-window/reconcile-<timestamp>.txt. Exits with the first failing
# step's result, or 0.
...
RECONCILE_SHA=3dfc1fc0bdaaa83ffec5bedfa43acee75f5c2ce04936845d2b57f1ef5e1f710c
