#!/bin/sh
# ga-gegx window source release: validate the coordinator source release against the live
# worker session, post it once to the ga-gegx notes, read it back and nudge.
...
# Log: ~/.local/share/gas-city-staging/ga-gegx-window/source-release-3-<timestamp>.txt. Exits with the first failing
# step's result, or 0.
...
RELEASE_SHA=deec27432802b0ab92dde05e29e171f4054c1d9e7d61c7c004758042b4a6d569
