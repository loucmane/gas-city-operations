#!/bin/sh
# ga-gegx window terminal: the full native integrity observation of the restored baseline,
# bound to the terminal suspension endpoint and the accepted restoration.
#
# Runs as a job of the host job runner (designs/gct-jobrunner), a oneshot unit started by the runner.
# Log: ~/.local/share/gas-city-staging/ga-gegx-window/terminal-<timestamp>.txt. Exits with the first failing
# step's result, or 0.
...
TERMINAL_SHA=e9818741274660b4d6db0c66270662f5954810710d24f9fe87b6bbda73d79df5
...
{ [ ! -e /var/tmp/ga-gegx-terminal-20260923-r1 ] && [ ! -L /var/tmp/ga-gegx-terminal-20260923-r1 ]; } || { echo "== STOP: output root already used: /var/tmp/ga-gegx-terminal-20260923-r1"; echo "== end"; exit 1; }
step() {
  label=$1; shift
