...
ga-gegx r11: a rebind of the reviewed ga-y49e base window-state-r6-read-safe.py (b10a3810) onto the
M5 baseline and task ga-gegx. Generated by make_window_base_r11.py with asserted replacements only.
"""
...
WORK = Path('/home/loucmane/gascity-core-worktrees/ga-gegx-typed-route-cycles')
...
def atomic_replace(path, raw, expected, mode, suffix):
    ...
    temp = path.parent/('.ga-gegx-'+suffix+'.tmp')
