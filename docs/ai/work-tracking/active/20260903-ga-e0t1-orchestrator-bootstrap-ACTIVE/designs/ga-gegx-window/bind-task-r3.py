"""One supported ga-gegx contract/enrollment patch; never route or resume.

ga-gegx r11: a rebind of the reviewed ga-y49e bind-task-r2.py. It runs as its own job BEFORE the
...
ROOT=Path('/var/tmp/ga-gegx-bind-20260923-r1')
HELPER=HERE/'window-base-r11.py'
HELPER_SHA='f0eeb1d2e59f780a842bd341cbf5818b5f93becf297f248f92e9b84951013c19'
...
def main():
    ...
    assert request=='{"schema":"gc.native-task-attempt.v1","store_ref":"rig:gascity","bead_id":"ga-gegx","template":"gascity/gc.implementation-worker","limit":1,"state":"requested"}'
    metadata={'gc.work_dir':WORK,'gc.work_branch':BRANCH,'gc.check_path':CHECK,
        ...
        'gc.implementation.summary_path':'.gc/worker-evidence/ga-gegx/implementation-summary.md',
