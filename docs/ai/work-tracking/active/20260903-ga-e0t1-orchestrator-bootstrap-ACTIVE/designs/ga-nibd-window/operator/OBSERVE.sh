#!/bin/sh
# ga-nibd window observe: the fresh accepted-state admission plus a full native integrity read,
...
# Log: ~/.local/share/gas-city-staging/ga-nibd-window/observe-<timestamp>.txt. Exits with the first failing
# step's result, or 0.
...
OBSERVE_SHA=03196c1cdda45e5f97490d972a9a02be313499df81f1116d3f9627f74d22166c
...
{ [ ! -e /var/tmp/ga-nibd-integrity-20260925-r5 ] && [ ! -L /var/tmp/ga-nibd-integrity-20260925-r5 ]; } || { echo "== STOP: output root already used: /var/tmp/ga-nibd-integrity-20260925-r5"; echo "== end"; exit 1; }
step() {
  label=$1; shift
