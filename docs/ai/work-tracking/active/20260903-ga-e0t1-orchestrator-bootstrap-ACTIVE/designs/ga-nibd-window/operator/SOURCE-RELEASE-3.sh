#!/bin/sh
# ga-nibd window source release: validate the coordinator source release against the live
...
# Log: ~/.local/share/gas-city-staging/ga-nibd-window/source-release-3-<timestamp>.txt. Exits with the first failing
# step's result, or 0.
