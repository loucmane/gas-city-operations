#!/bin/sh
# ga-nibd window resume: rig-resume, the read-only queue audit, then city-resume, once each.
#
# Runs as a job of the host job runner (designs/gct-jobrunner), a oneshot unit started by the runner.
# Log: ~/.local/share/gas-city-staging/ga-nibd-window/resume-<timestamp>.txt. Exits with the first failing
# step's result, or 0.
...
WINDOW_SHA=df9eae45980d744277b9c2d829c014b12b19e09520f9f0d4ca924966eda889b2
...
[ -e /var/tmp/ga-nibd-route-20260923-r1/result.json ] && [ -e /var/tmp/ga-nibd-audit-route-20260923-r1/result.json ] || { echo "== STOP: ROUTE has not passed"; echo "== end"; exit 1; }
...
work=/home/loucmane/gascity-core-worktrees/ga-nibd-typed-route-cycles
...
{ [ ! -e /var/tmp/ga-nibd-audit-resume-20260923-r1 ] && [ ! -L /var/tmp/ga-nibd-audit-resume-20260923-r1 ]; } || { echo "== STOP: output root already used: /var/tmp/ga-nibd-audit-resume-20260923-r1"; echo "== end"; exit 1; }
{ [ ! -e /var/tmp/ga-nibd-window-20260925-r2/rig-resume-started.json ] && [ ! -L /var/tmp/ga-nibd-window-20260925-r2/rig-resume-started.json ]; } || { echo "== STOP: output root already used: /var/tmp/ga-nibd-window-20260925-r2/rig-resume-started.json"; echo "== end"; exit 1; }
step() {
  label=$1; shift
