#!/bin/sh
# ga-nibd window prep r6: the isolation overlay and its receipt image. Read-only: installs nothing
# and launches no worker. It writes its fresh evidence root /var/tmp/ga-nibd-prep-20260925-r1 plus the
...
# Log: ~/.local/share/gas-city-staging/ga-nibd-window/prep-<timestamp>.txt. Exits with the prep result.
...
PREP_SHA=462c6593134dd8bd6640f4e9ed61a190a78bff12eb493d804cfbb06d55daf955
OUT=/var/tmp/ga-nibd-prep-20260925-r1
