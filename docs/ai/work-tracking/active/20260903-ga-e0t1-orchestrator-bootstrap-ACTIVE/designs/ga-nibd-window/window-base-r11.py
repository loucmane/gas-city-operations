...
ga-nibd r11: a rebind of the reviewed ga-y49e base window-state-r6-read-safe.py (b10a3810) onto the
M5 baseline and task ga-nibd. Generated by make_window_base_r11.py with asserted replacements only.
"""
...
ROOT = Path('/var/tmp/ga-nibd-window-20260925-r2')
PREP = Path('/var/tmp/ga-nibd-prep-20260925-r1')
...
WORK = Path('/home/loucmane/gascity-core-worktrees/ga-nibd-typed-route-cycles')
...
def approved_recovery_image(prior, root, result_sha):
    ...
    accepted = json.loads(read(Path('/var/tmp/ga-f37t-window-20260925-r2/suspension-baseline.json'), '771107c0d53eed26780fe63f4f2311849b54a1d373e9d12770633e2348d4c137'))
...
def atomic_replace(path, raw, expected, mode, suffix):
    ...
    temp = path.parent/('.ga-nibd-'+suffix+'.tmp')
