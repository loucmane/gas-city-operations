"""One supported ga-nibd contract/enrollment patch; never route or resume.

ga-nibd r11: a rebind of the reviewed ga-y49e bind-task-r2.py. It runs as its own job BEFORE the
...
def main():
    ...
    assert request=='{"schema":"gc.native-task-attempt.v1","store_ref":"rig:gascity","bead_id":"ga-nibd","template":"gascity/gc.implementation-worker","limit":1,"state":"requested"}'
    metadata={'gc.work_dir':WORK,'gc.work_branch':BRANCH,'gc.check_path':CHECK,
        ...
        'gc.implementation.summary_path':'.gc/worker-evidence/ga-nibd/implementation-summary.md',
